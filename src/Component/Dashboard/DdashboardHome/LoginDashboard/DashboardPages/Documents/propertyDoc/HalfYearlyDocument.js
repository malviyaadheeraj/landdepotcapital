...
const HalfYearlyDocument = ({ getInvestmentList }) => {
                ...
                <td className="proprty-data">
                  <b>
                    {investList.property[0] &&
                      investList.property[0].half_yearly_document_name}
                  </b>
                </td>
                <td className="proprty-data">
                  {investList.property[0] &&
                  investList.property[0].half_yearly_document ? (
...
export default HalfYearlyDocument;
